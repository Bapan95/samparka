<x-guest-layout>
    ...
    <form method="POST" action="{{ route('login') }}">
        ...
        <div class="mt-4">
            ...
            <div class="mb-3 flex items-center">
                <img id="captcha_image" src="{{ captcha_src('math') }}" alt="CAPTCHA Image" class="border rounded" />
                <button type="button" id="refresh_captcha"
                    class="ml-2 px-3 py-1 text-sm bg-gray-300 hover:bg-gray-400 rounded">
    ...
    <script>
        // Prevent browser back navigation for unauthenticated users
        (function() {
