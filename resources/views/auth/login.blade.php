<x-guest-layout>
    ...
    <form method="POST" action="{{ route('login') }}">
        ...
        <div class="mt-4">
            ...
            <div class="mb-3">
                <img src="{{ route('captcha') }}" alt="CAPTCHA Image" class="border rounded" />
            </div>
            <x-text-input id="captcha_input" class="block mt-1 w-full" type="text" name="captcha_input" required />
